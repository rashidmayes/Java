...
public class WizardParser extends DefaultHandler 
{
    ...
    public Wizard parse(InputStream is) throws SAXException, IOException
    {
        return parse(new InputSource(is));
    }
    
    public Wizard parse(InputSource inputSource) throws SAXException, IOException
    {
    ...
    {
        if ( "startText".equalsIgnoreCase(localName) )
        {
            wizard.startText = buffer.toString();
        }
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            is = WizardParser.class.getResourceAsStream("/wizardtest.xml");
            Wizard wizard = new WizardParser().parse(new InputSource(is));
            
            
            System.out.println(wizard.elements());
            
            for ( Iterator<Form> iter = wizard.elements(); iter.hasNext(); )
            {    
            ...
            System.out.println(wizard2.elements());
            
            for ( Iterator<Form> iter = wizard2.elements(); iter.hasNext(); )
            {    
                System.out.println(iter.next().getName());   
            }
        }
        ...
        {
            LogWriter.system.log(WizardParser.class,e);
        }
        finally
        {
